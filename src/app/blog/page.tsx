...
export const metadata: Metadata = {
  title: "IPTV Blog, Guides & Streaming Insights | NixaTV",
  description: "Explore the latest IPTV guides, Firestick setup instructions, Smart TV app comparisons, and streaming optimization tutorials from NixaTV engineers.",
  alternates: {
    canonical: "/blog",
  },
};
